...
3. Ejecute `DocAnonymizer-0.3.1.exe` y siga las indicaciones de Windows. El instalador reemplaza cualquier valor de usuario anterior de `TESSERACT_COMMAND` por `C:\Program Files\Tesseract-OCR\tesseract.exe`.
