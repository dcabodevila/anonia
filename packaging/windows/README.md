...
El instalador EXE por usuario incluye la aplicación y Java, y crea el acceso directo y la entrada de menú Inicio definidos por el empaquetado. No redistribuye ni instala Tesseract ni modelos OCR; esa dependencia se administra externamente para quienes procesarán imágenes.
...
`target/windows-installer/DocAnonymizer-0.2.0.exe`. Usa un directorio nuevo
