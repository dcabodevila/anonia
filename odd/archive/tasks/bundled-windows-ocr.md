# Historical bundled Windows OCR investigation (superseded)

> Historical record only. Paths and results below reflect an abandoned bundle investigation, not current product requirements. The source downloads and audit dossier were removed during approved cleanup; the tracked original dossier remains recoverable from `6131ea9`.
